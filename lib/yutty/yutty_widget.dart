...
class YuttyWidget extends StatefulWidget {
  const YuttyWidget({Key key}) : super(key: key);

  @override
  _YuttyWidgetState createState() => _YuttyWidgetState();
}

class _YuttyWidgetState extends State<YuttyWidget> {
